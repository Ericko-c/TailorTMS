...
export const FuelStatusBarGraph = () => {
    ...
    const [apiResponse,setAPIResponse]=useState(20);
    const [deliveredOrders,setDeliveredOrders]=useState(10)
    const [declinedOrders,setDeclinedOrders]=useState(5)
    const [Loading,setLoading]=useState(false);
    const [emergencyOrders,setEmergencyOrders]=useState(15)
    const [receivedOrders,setReceivedOrders]=useState(12)
