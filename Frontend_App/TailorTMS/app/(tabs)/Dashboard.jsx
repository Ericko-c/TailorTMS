...
import {FuelStatusBarGraph} from '../../componets/Analytics/fuelstatus.jsx';
...
// get declined/canceled orders
  ...
  return (
    <SafeAreaView style={styles.container} edges={['left','right']}>
        ...
        >
        <Text style={styles.titleTxt}>Welcome back <Text style={styles.subTxt}>{station?.username || "Tailor"}!</Text></Text>
            ...
            <View style={styles.TopContainer2}>
                ...
                >
                    ...
                    <Text style={styles.TopSubTxt}>{deliveredFuel || 0}</Text>
                        )
                    }
                </TouchableOpacity>
            ...
            {/* container 3 */}
                ...
                <TouchableOpacity style={styles.Tcontainer202}
                    onPress={()=>router.push("/Orders")}
                >
                    <Text style={styles.TopTxt}>Assigned Orders</Text>
                    {
                        Loading ? (
                            <Loader/>
                        ):(
