...
const requestOTP = async (req, res) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: email,
      subject: "TailorTMS Password Reset Verification Code",
      html: `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #eee; padding: 20px; border-radius: 8px;">
        ...
        <p>Hello,</p>
        <p>We received a request to reset the password for your TailorTMS account. Use the verification code below to complete the process:</p>
        ...
        <p>Thank you for choosing TailorTMS.</p>
        <hr style="border: none; border-top: 1px solid #eee; margin: 20px 0;">
        <p style="font-size: 12px; color: #888;">TailorTMS Support Team</p>
        </div>`,
    });
